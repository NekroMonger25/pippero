...
exports.scrapeEurostreaming = scrapeEurostreaming;
...
async function scrapeEurostreaming(imdbId, season, episode) {
    ...
    try {
        ...
        for (const url of seriesUrls) {
            ...
            if (episodeContent) {
                ...
                if (supervideo) {
                    console.log('Found Supervideo link:', supervideo[1]);
                    const modifiedUrl = supervideo[1]
